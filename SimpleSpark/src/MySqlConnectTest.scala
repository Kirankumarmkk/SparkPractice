...
var passfile: String = ""
		...
		val ss = SparkSession.builder().appName("JDBC Test").master("local[2]").config("spark.sql.warehourse.dir","file:///c:/temp/spark-warehouse").getOrCreate()
    ...
    import org.apache.spark.sql.SQLContext;
		...
		//		dataframe_mysql.rdd.saveAsTable("scala.scala_test_1")
