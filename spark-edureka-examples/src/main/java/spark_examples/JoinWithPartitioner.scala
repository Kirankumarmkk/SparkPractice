...
object JoinWithPartitioner {
  ...
  def main(args: Array[String]) {
    ...
    val custs = sc.textFile("C:\\Kiran\\Big\\Scala\\spark-edureka-examples_mo2t1\\spark-edureka-examples\\data-files\\custs").map(_.split("\t"))
    ...
    val txns = sc.textFile("C:\\Kiran\\Big\\Scala\\spark-edureka-examples_mo2t1\\spark-edureka-examples\\data-files\\custs_txns").map(_.split("\t"))
    /*
